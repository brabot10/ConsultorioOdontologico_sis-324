...
jQuery(document).ready(function ($) {
    ...
    //    if (!isDateOldEnough(fechaNacimiento)) {
    //        // La fecha de nacimiento no es válida
    //        document.getElementById("errorFechaNacimiento").innerHTML = "La fecha de nacimiento debe ser al menos un año y un día.";
    //        return false;
    //    } else {
    ...
    //    if (!isDateOldEnough(fechaNacimiento)) {
    //        // La fecha de nacimiento no es válida
    //        document.getElementById("fechaNacimiento").setCustomValidity("La fecha de nacimiento debe ser al menos un año y un día.");
    //    } else {
    //        // La fecha de nacimiento es válida
    //        document.getElementById("fechaNacimiento").setCustomValidity("");
    //    }
    //}
