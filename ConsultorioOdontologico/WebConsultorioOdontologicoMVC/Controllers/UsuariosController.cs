...
namespace WebConsultorioOdontologicoMVC.wwwroot
{
    public class UsuariosController : Controller
    {
        private readonly LabSis324Context _context;

        public UsuariosController(LabSis324Context context)
        {
            _context = context;
        }
        ...
        {
            var labSis324Context = _context.Usuarios.Include(u => u.IdPersonalNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LabSis324Context.Usuarios'  is null.");
            }
            var usuario = await _context.Usuarios.FindAsync(id);
            if (usuario != null)
            {
