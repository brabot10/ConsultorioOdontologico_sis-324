...
namespace WebConsultorioOdontologicoMVC.Controllers
{
    public class InventariosController : Controller
    {
        ...
        public InventariosController(LabSis324Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Inventarios != null ? 
                          ...
                          Problem("Entity set 'LabSis324Context.Inventarios'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Articulo,Precio,UsuarioRegistro,FechaRegistro,Estado")] Inventario inventario)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LabSis324Context.Inventarios'  is null.");
            }
            var inventario = await _context.Inventarios.FindAsync(id);
            if (inventario != null)
            {
